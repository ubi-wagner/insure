...
COUNTY_MARKET_DATA: dict[str, dict[str, Any]] = {
    ...
    # ── Panhandle Gulf Coast (post-Sally / post-Michael) ──
    "Bay": {
        "base_rate": 10.5,
        "active_carriers": 12,
        "citizens_pct": 0.18,
        ...
        "market_hardness": "hard",
        "coastal_mult": 2.2,
        "region": "panhandle_michael_impact",
    },
    "Walton": {
        "base_rate": 9.0,
        "active_carriers": 14,
    ...
    "Brevard": {
        ...
        "market_hardness": "moderate",
        "coastal_mult": 1.9,
        "region": "central_atlantic_space_coast",
    },
    "Indian River": {
        "base_rate": 8.5,
        "active_carriers": 16,
